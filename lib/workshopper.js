...
Workshopper.prototype.execute = function (mode, submission, args) {
  ...
  exercise.on('pass', onpass.bind(this, exercise))
  exercise.on('fail', onfail.bind(this, exercise))

  exercise[mode](submission, args)
}
...
function onfail (exercise, dir, current) {
